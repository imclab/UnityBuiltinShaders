...
// - much less per-vertex work compared with Mobile-VertexLit
// - supports only 1 DIRECTIONAL light and ambient term
// - no per-material color
// - no specular
// - no emission

Shader "Mobile/VertexLit (1 Directional Light)" {
	Properties {
...
v2f_surf vert_surf (appdata_full v) {
	...
	o.vlight = UNITY_LIGHTMODEL_AMBIENT.xyz;
